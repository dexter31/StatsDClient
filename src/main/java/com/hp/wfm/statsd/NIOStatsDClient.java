 ...
 *
 */
public final class NIOStatsDClient extends ConvenienceMethodProvidingStatsDClient {
    ...
    private static NonBlockingUdpSender sender = null;
     ...
     */
    public NIOStatsDClient(String prefix, String hostname, int port) throws StatsDClientException {
     ...
     *     if the client could not be started
     */
    public NIOStatsDClient(String prefix, String hostname, int port, StatsDClientErrorHandler errorHandler) throws StatsDClientException {
